...
{
	std::cout << "Test Discrete_Convolution_2_Odd\n====================================\n\n";
	vector<double> temp;
	...
	std::cout<<"\nChecking whether gaussians are normalized.\nAREAS:"<<std::endl; 
